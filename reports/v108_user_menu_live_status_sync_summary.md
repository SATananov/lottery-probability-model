...
- Live source: `v107`
- Dataset rows: `10059`
- Latest draw: `2026-06-25` — `[5, 11, 44, 46, 47, 48]`
...
- `OK` — live_dataset_rows_current: rows=10059, source=v107
- `OK` — live_latest_draw_current: latest_date=2026-06-25, numbers=[5, 11, 44, 46, 47, 48]
