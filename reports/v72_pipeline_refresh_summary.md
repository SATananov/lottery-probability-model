...
Планирани стъпки: **13**
Всички скриптове са налични: **False**
Всички артефакти са налични: **False**
...
| 66 | Претеглен ансамбъл анализ | `scripts/v66_build_weighted_smart_ensemble.py` | False | False | planned |
...
| 71 | Пакет за игра | `scripts/v71_build_ticket_pack_export.py` | False | True | planned |
