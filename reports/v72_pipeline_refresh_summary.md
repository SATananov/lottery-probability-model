...
|---:|---|---|---|---|---|
| 61 | Анализ на нов тираж | `scripts/v61_build_draw_result_analyzer.py` | True | True | planned |
| 62 | История на моделите | `scripts/v62_build_model_performance_tracker.py` | True | True | planned |
| 63 | Надеждност на моделите | `scripts/v63_build_model_reliability_dashboard.py` | True | True | planned |
| 65 | Умно тегло на моделите | `scripts/v65_build_model_weighting_center.py` | True | True | planned |
| 66 | Претеглен ансамбъл анализ | `scripts/v66_build_weighted_smart_ensemble.py` | True | True | planned |
...
| 76 | Обяснимост и валидация | `scripts/v76_build_explainability_validation_center.py` | True | True | planned |
| 77 | Решение и препоръка | `scripts/v77_build_decision_recommendation_center.py` | True | True | planned |
| 78 | Финален план | `scripts/v78_build_final_play_plan_center.py` | True | True | planned |
| 79 | Експорт и изпълнение | `scripts/v79_build_ticket_pack_export_center.py` | True | True | planned |
| 80 | Финален системен одит | `scripts/v80_build_final_system_audit_center.py` | True | True | planned |
| 81 | Финален UX контрол | `scripts/v81_build_final_ux_navigation_center.py` | True | True | planned |
| 82 | Финален пакет за предаване | `scripts/v82_build_final_release_package_center.py` | True | True | planned |
