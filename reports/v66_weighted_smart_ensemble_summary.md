...
| v44.1 — финален комбиниран анализ комбинация | 0.204663 | 0.229651 | reports/v44_1_final_комбиниран анализ_number_scores.csv<br>reports/v44_1_final_комбиниран анализ_ticket_summary.json<br>models/v44_1/v44_1_final_комбиниран анализ_number_scores.json<br>models/v44_1/v44_1_final_комбиниран анализ_ticket_prediction.json |
...
| v51 — портфолио от фишове | 0.054404 | 0.061046 | reports/v51_current_pro_ticket_score.csv |
...
| v58 — обединена оценка | 0.054404 | 0.061046 | reports/v58_smart_комбиниран анализ_scores_sample.csv<br>reports/v58_smart_комбиниран анализ_scores_sample.json |
