...
- Train draw прозорец: **7967**
- Test draw прозорец: **1992**
- Средно познати числа в top 6 при тест: **0.748**
- Максимум познати числа в top 6 при тест: **4**
- Top neural числа за следващ анализ: **21, 34, 45, 40, 2, 25**

## Кандидат фишове

- Фиш 1: **2, 21, 29, 41, 42, 44** (оценка 0.5166)
- Фиш 2: **11, 20, 21, 27, 34, 44** (оценка 0.5153)
- Фиш 3: **2, 11, 25, 27, 38, 45** (оценка 0.5205)
- Фиш 4: **7, 21, 27, 28, 34, 45** (оценка 0.5209)
- Фиш 5: **2, 21, 25, 34, 43, 45** (оценка 0.5343)
- Фиш 6: **2, 13, 19, 25, 30, 44** (оценка 0.5193)
- Фиш 7: **3, 13, 25, 30, 38, 44** (оценка 0.5147)
- Фиш 8: **2, 21, 30, 40, 42, 45** (оценка 0.5278)
