...
def render_v66_weighted_smart_ensemble_section():
    st.title("Претеглен ensemble анализ")
    st.caption(
        "Комбинира Step 65 адаптивните тегла с наличните score източници, "
...
4. Преизчислява теглата само между реално наличните score източници.
