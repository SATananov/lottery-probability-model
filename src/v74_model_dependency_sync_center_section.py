...
CATEGORY_BG = {
    ...
    "Обяснителен контрол": "Обяснимост и валидация",
    "Обяснимост и валидация": "Обяснимост и валидация",
    "Решение и препоръка": "Решение и препоръка",
    "Финален план": "Финален план",
    "Експорт и изпълнение": "Експорт и изпълнение",
}
