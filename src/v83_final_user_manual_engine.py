...
def _workflow_rows() -> list[dict[str, Any]]:
    return [
        ...
        {"step_order": 8, "page": "Финален план", "when_to_use": "Когато подготвяш реалния пакет.", "expected_result": "Получаваш активни комбинации, резерви и действия.", "caution": "Пази фиксиран бюджет и не променяй плана емоционално."},
        ...
        {"step_order": 10, "page": "Финален пакет за предаване / Контрол на синхрона", "when_to_use": "След по-големи промени или преди чист ZIP.", "expected_result": "Проверяваш дали app/reports/models са синхронизирани.", "caution": "Не прави чист ZIP при нечист Git статус или неуспешни проверки."},
    ]
...
def _safe_checklist_rows() -> list[dict[str, Any]]:
    return [
        ...
        {"check_order": 7, "check_item": "Clean ZIP само при чист статус", "recommended_behavior": "Първо commit и push и празен git status, после архив.", "risk_if_ignored": "Непълен или несинхронизиран checkpoint."},
    ]
