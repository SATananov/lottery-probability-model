...
from src.v100_final_release_lock_engine import build_and_save
...
if __name__ == "__main__":
    ...
    print("STEP_100_STATUS", payload.get("status", "UNKNOWN"))
    print("ACTIVE_PLAN", active_plan.get("strategy_type", "-"), active_plan.get("combination_count", 0), active_plan.get("cost_text", "0.00 EUR"))
