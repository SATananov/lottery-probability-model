...
def main() -> int:
    ...
    metadata_pairs = [
        ...
        (ROOT / "CLEAN_ZIP_MANIFEST_STEP150_2.md", ROOT / "FULL_CLEAN_CHECKPOINT_MANIFEST_STEP150_2.md"),
    ]
    ...
    if not failures:
        ...
        if release.get("checkpoint") not in {"Step 146", "Step 147", "Step 148", "Step 149", "Step 150", "Step 150.1", "Step 150.2"}:
