...
def main() -> int:
    ...
    metadata_pairs = (
        ...
        (ROOT / "CLEAN_ZIP_MANIFEST_STEP150_3.md", ROOT / "FULL_CLEAN_CHECKPOINT_MANIFEST_STEP150_3.md"),
        (ROOT / "CLEAN_ZIP_MANIFEST_STEP151.md", ROOT / "FULL_CLEAN_CHECKPOINT_MANIFEST_STEP151.md"),
        (ROOT / "CLEAN_ZIP_MANIFEST_STEP151_2.md", ROOT / "FULL_CLEAN_CHECKPOINT_MANIFEST_STEP151_2.md"),
        (ROOT / "CLEAN_ZIP_MANIFEST_STEP151_2_1.md", ROOT / "FULL_CLEAN_CHECKPOINT_MANIFEST_STEP151_2_1.md"),
        (ROOT / "CLEAN_ZIP_MANIFEST_STEP151_2_2.md", ROOT / "FULL_CLEAN_CHECKPOINT_MANIFEST_STEP151_2_2.md"),
    )
    ...
    if not failures:
        ...
        if release.get("checkpoint") not in {"Step 148", "Step 149", "Step 150", "Step 150.1", "Step 150.2", "Step 150.3", "Step 151", "Step 151.2", "Step 151.2.1", "Step 151.2.2"}:
