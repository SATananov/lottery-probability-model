...
def main() -> int:
    ...
    if not failures:
        ...
        if release.get("checkpoint") not in {"Step 147", "Step 148", "Step 149", "Step 150", "Step 150.1", "Step 150.2", "Step 150.3"}:
        ...
        if '"Решение за изследователските модели"' not in streamlit_text:
